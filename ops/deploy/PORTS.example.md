...
| photo-studio-marketplace | `/opt/apps/photo-studio-marketplace` | `http://204.168.163.99/photo-studio-marketplace/` and `http://204.168.163.99:3002/photo-studio-marketplace/` | `4003` | `15433` | `photo-studio-marketplace-api.service`, `caddy.service` | `photo_studio_marketplace` |
